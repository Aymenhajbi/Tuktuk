...
const process_signal_dto_1 = require("./dto/process-signal.dto");
...
__decorate([
    (0, common_1.Post)('process-signal'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [process_signal_dto_1.ProcessSignalDto]),
    __metadata("design:returntype", void 0)
], OrchestratorController.prototype, "processSignal", null);
exports.OrchestratorController = OrchestratorController = __decorate([
    (0, swagger_1.ApiTags)('orchestrator'),
    (0, common_1.Controller)('modules/orchestrator'),
